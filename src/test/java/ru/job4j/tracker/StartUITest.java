...
class StartUITest {
    ...
    public void whenCreateItem() {
        ...
        List<UserAction> actions = List.of(new CreateAction(output), new Exit());
    ...
    public void whenReplaceItem() {
        ...
        List<UserAction> actions = List.of(new ReplaceAction(output), new Exit());
        new StartUI(output).init(in, tracker, actions);
    ...
    public void whenDeleteItem() {
        ...
        List<UserAction> actions = List.of(new DeleteAction(output), new Exit());
        new StartUI(output).init(in, tracker, actions);
    ...
    public void whenShowAllActionTestOutputIsSuccessfully() {
        ...
        List<UserAction> actions = List.of(new ShowAllAction(out), new Exit());
        new StartUI(out).init(in, tracker, actions);
        String ln = System.lineSeparator();
        assertThat(out.toString()).isEqualTo(
                "Menu:" + ln
